    ...
    <div className="space-y-6">
      <div className="bg-slate-900 text-white p-6 rounded-2xl shadow-lg flex justify-between items-center">
        <div>
          ...
          <h1 className="text-2xl font-black mt-2">AgriCorp Processing Ltd</h1>
          <p className="text-slate-300 text-sm mt-1">Post crop purchase requirements, source directly from verified farmers & FPO produce pools.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
          <h3 className="text-lg font-bold text-gray-900 border-b pb-2">📋 Post Purchase Requirement</h3>
          <form onSubmit={handleCreate} className="space-y-3 text-sm">
            <div>
              <label className="block font-bold text-gray-700 mb-1">Buyer Category</label>
            ...
            <div>
              <label className="block font-bold text-gray-700 mb-1">Required Quantity (kg)</label>
            ...
            <div>
              <label className="block font-bold text-gray-700 mb-1">Max Offer Price (₹/kg)</label>
            ...
            <div>
              <label className="block font-bold text-gray-700 mb-1">Target District</label>
        ...
        <div className="lg:col-span-2 space-y-4">
          <h3 className="text-lg font-bold text-gray-900">Active Procurement Requirements</h3>
            ...
            {requirements.map((req) => (
              <div key={req.id} className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm flex justify-between items-center">
                <div>
                  ...
                  <p className="text-xs text-gray-600">Posted by {req.buyerName} • Quality: {req.grade}</p>
                </div>
