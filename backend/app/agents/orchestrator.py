"""
Agentic Orchestrator — KisanSetu AI assistant backed by LangGraph & Gemini API.
"""
...
SYSTEM_PROMPT = """You are KisanSetu AI, a senior agricultural market advisor for Indian farmers.
